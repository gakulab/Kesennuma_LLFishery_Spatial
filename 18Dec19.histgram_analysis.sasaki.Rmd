...
```{r}
#base_data
data1<-read.csv("14Jun19_Operation_Data.2012_2018.sasaki.csv",                           stringsAsFactors=FALSE,header=T,na.strings="NULL")
```

##market_dataの入力
```{r}
#市況データ
M_data1<-read.csv("~/Kesennuma_LLFishery_Spatial/CSV_Data/Operation_Data/kesennuma_market_20090401_20180331.csv",
