...
##market_dataの入力
```{r}
if(User==1){M_data1<-read.csv("kesennuma_market_20090401_20180331.csv",fileEncoding="CP932",
...
if(User==1){English_Names <- 
  read.csv("10May18FishName_gaku_checked.csv",header=T,fileEncoding="CP932")}else if
...
```{r}
if(User==1){Fukuyo_data<-read.csv("6May19.Fukuyo_8.market_data.csv",fileEncoding="CP932",
                            stringsAsFactors=FALSE,header=T,na.strings="NULL")}else if 
...
##漁船名セットの入力
```{r}
if(User==1){Vessel_Name_Match<-read.csv("6May.19.Vessel_Name_Match.csv",fileEncoding="CP932",
                            stringsAsFactors=FALSE,header=T,na.strings="NULL")}else if 
