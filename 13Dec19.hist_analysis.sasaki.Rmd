...
```{r}
#base_data
data1<-read.csv("14Jun19_Operation_Data.2012_2018.sasaki.csv",
                            stringsAsFactors=FALSE,header=T,na.strings="NULL")
```

##market_dataの入力
```{r}
M_data1<-read.csv("kesennuma_market_20090401_20180331.csv",fileEncoding="CP932",
                            stringsAsFactors=FALSE,header=T,skip=1,na.strings="NULL")
...
```{r}
Fukuyo_data<-read.csv("6May19.Fukuyo_8.market_data.csv",fileEncoding="CP932",
                            stringsAsFactors=FALSE,header=T,na.strings="NULL")
...
##漁船名セットの入力
```{r}
Vessel_Name_Match<-read.csv("6May.19.Vessel_Name_Match.csv",fileEncoding="CP932",
                            stringsAsFactors=FALSE,header=T,na.strings="NULL")
```
